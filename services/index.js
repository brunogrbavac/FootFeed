...
let match_instance = new match_class(models.Match, models.Team, models.Event, models.Photo, models.User, models.Competition,models.player_event, nodeLogger); // stvaramo instance klasa za rad s pojedinim Sequelize MODELIMA
