...
const photoController = require('../../controllers/photo-controller/http'); //kontroler ima sve funkcije koje nam trebaju kao reakcija na requestove
...
module.exports = function(main_router){
    ...
    photoRouter.post('/add', checkIfUser, upload.single('image'), photoController.addPhoto); 
