...
const matchController = require('../controllers/match-controller'); // kontroler ima sve funkcije koje nam trebaju kao reakcija na requestove
...
module.exports = function(main_router){
    ...
    matchRouter.get('/match/live/:id',checkIfUser, matchController.goLiveMatch);
}
