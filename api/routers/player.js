...
const playerController = require('../controllers/player-controller'); //kontroler ima sve funkcije koje nam trebaju kao reakcija na requestove
...
module.exports = function(main_router){
    ...
    playerRouter.get('/all', playerController.getAllPlayers); //ne briši nikad jer služi za primjer
}